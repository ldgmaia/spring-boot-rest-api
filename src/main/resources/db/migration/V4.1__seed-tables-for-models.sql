...
VALUES
	 ...
	 ('Camera model','Camera model','Camera model',1,0,NULL,NULL,7,1),
	 ...
	 ('battery model','battery model','battery model',1,0,NULL,NULL,6,1),
	 ('ram model','ram model','ram model',1,0,NULL,NULL,3,1),
