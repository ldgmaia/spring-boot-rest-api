...
////                ri.id, po.poNumber, ri.description, ri.status, poi.quantityOrdered, ri.quantity, s.name, ri.createdAt
////            )
...
////    @Query("""
////            SELECT new com.example.api.domain.assessments.PendingAssessmentListDTO(
////                ai.id, po.poNumber, ai.description, ai.status, poi.quantityOrdered, ai.quantity, s.name, ai.createdAt
////            )
